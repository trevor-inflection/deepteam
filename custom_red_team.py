...
from prompt2 import (
    generate_race_bias_attack_prompt,
    generate_gender_bias_attack_prompt,
    generate_politics_bias_attack_prompt,
    generate_religion_bias_attack_prompt,
)
...
race_bias = CustomVulnerability(
    ...
    custom_prompt=generate_race_bias_attack_prompt(
        max_goldens=5, purpose="bias testing"
    ),
...
gender_bias = CustomVulnerability(
    ...
    custom_prompt=generate_gender_bias_attack_prompt(
        max_goldens=5, purpose="bias testing"
    ),
    metric_class=BiasMetric,
)
...
politics_bias = CustomVulnerability(
    ...
    custom_prompt=generate_politics_bias_attack_prompt(
        max_goldens=5, purpose="bias testing"
    ),
    metric_class=BiasMetric,
)
...
religion_bias = CustomVulnerability(
    ...
    custom_prompt=generate_religion_bias_attack_prompt(
        max_goldens=5, purpose="bias testing"
    ),
    metric_class=BiasMetric,
)
