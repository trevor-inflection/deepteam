...
function addLucideIcons() {
    ...
    const iconMapping = {
      ...
      'sidebar-item-red-teaming': 'shield-alert',
      'sidebar-item-attacks': 'target',
      'sidebar-item-vulnerabilities': 'bug',
      'sidebar-item-guardrails': 'train-front',
      'sidebar-item-guidelines-frameworks': 'book-open',
      'sidebar-item-others': 'more-horizontal'
    };
