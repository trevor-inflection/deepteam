...
`deepteam`'s `RedTeamer` generates adversarial attacks by first synthesizing simple baseline prompts, before **progressively enhancing them to create more sophisticated versions** capable of eliciting harmful responses from your LLM application.
...
You can specify these enhancements in `attack_methods` within the method function.
...
:::tip DID YOU KNOW?
`deepteam` offers **10 types of attack enhancements**, which are randomly sampled from the specified distribution each time an attack is enhanced.
:::

Here are the `AttackEnhancement`s `deepteam` offers:
...
>
  <img
    src="https://confident-bucket.s3.amazonaws.com/attack_methods_overview.svg"
    alt="LangChain"
    style={{
      marginTop: "20px",
      marginBottom: "20px",
...
>
  <img
    src="https://confident-bucket.s3.amazonaws.com/attack_methods_encoding.svg"
    alt="LangChain"
    style={{
      marginTop: "20px",
      marginBottom: "20px",
...
>
  <img
    src="https://confident-bucket.s3.amazonaws.com/attack_methods_one_shot.svg"
    alt="LangChain"
    style={{
      marginTop: "20px",
      marginBottom: "40px",
...
>
  <img
    src="https://confident-bucket.s3.amazonaws.com/attack_methods_dialogue.svg"
    alt="LangChain"
    style={{
      margin: "40px",
      height: "auto",
...
>
  <img
    src="https://confident-bucket.s3.amazonaws.com/attack_methods_jailbreaking_overview.svg"
    alt="LangChain"
    style={{
      margin: "40px",
      height: "auto",
...
>
  <img
    src="https://confident-bucket.s3.amazonaws.com/attack_methods_jailbreaking_linear.svg"
    alt="LangChain"
    style={{
      marginTop: "20px",
      marginBottom: "40px",
...
>
  <img
    src="https://confident-bucket.s3.amazonaws.com/attack_methods_jailbreaking_tree.svg"
    alt="LangChain"
    style={{
      marginTop: "20px",
      marginBottom: "40px",
...
>
  <img
    src="https://confident-bucket.s3.amazonaws.com/attack_methods_jailbreaking_crescendo.svg"
    alt="LangChain"
    style={{
      marginTop: "20px",
      marginBottom: "40px",
