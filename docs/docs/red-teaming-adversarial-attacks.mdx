...
| `RoleplayReplay`        | Embeds attacks within elaborate persona-based scenarios where the LLM adopts specific character roles, leveraging collaborative training to bypass safety mechanisms through authentic character portrayal. |
