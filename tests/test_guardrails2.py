...
def main():
    ...
    print("\n5. **Guards Available:**")
    print(
        "   ✅ DeepTeam has 7 core guards: ToxicityGuard, PromptInjectionGuard, PrivacyGuard, IllegalGuard,"
    )
    print("      HallucinationGuard, TopicalGuard, CybersecurityGuard")
    print(
        "   ✅ Merged functionality: GraphicContent→Toxicity, Jailbreaking→PromptInjection"
    )
    print(
        "   ❌ Removed: SyntaxGuard (IDE feature), ModernizationGuard (opinion not safety)"
    )
