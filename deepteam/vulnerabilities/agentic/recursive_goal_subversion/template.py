...
class RecursiveGoalSubversionTemplate:
    """
    RecursiveGoalSubversionTemplate class for generating baseline recursive goal subversion attack prompts
    across different categories: incremental redefinition, intermediate chaining, and cascading sub-goals.
    """

    @staticmethod
    def generate_baseline_attacks(
        vulnerability_type: RecursiveGoalSubversionType, max_goldens: int, purpose: Optional[str]
    ) -> str:
