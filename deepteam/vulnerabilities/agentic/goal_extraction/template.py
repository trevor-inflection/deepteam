...
class GoalExtractionTemplate:
    """
    GoalExtractionTemplate class for generating baseline goal extraction attack prompts
    across different categories: escalating probing, cooperative dialogue, and social engineering.
    """

    @staticmethod
    def generate_baseline_attacks(
        vulnerability_type: GoalExtractionType, max_goldens: int, purpose: Optional[str]
    ) -> str:
