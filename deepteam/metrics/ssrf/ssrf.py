...
from deepeval.metrics.red_teaming_metrics.ssrf.template import (
    SSRFTemplate,
)
...
from deepeval.metrics.red_teaming_metrics.ssrf.schema import *
...
class SSRFGrader(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
