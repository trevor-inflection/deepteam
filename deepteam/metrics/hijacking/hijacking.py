...
from deepeval.metrics.red_teaming_metrics.hijacking.template import (
    HijackingTemplate,
)
...
from deepeval.metrics.red_teaming_metrics.hijacking.schema import *
...
class HijackingGrader(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
